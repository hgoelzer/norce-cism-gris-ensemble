...
#./check_run_func.sh MARv3.9 CESM2 ssp585 high
#./check_run_func.sh MARv3.9 CESM2 ssp585 low
#./check_run_func.sh MARv3.9 CESM2 ssp585 med
...
#./check_run_func.sh MARv3.9 UKESM1-CM6 ssp585 high
#./check_run_func.sh MARv3.9 UKESM1-CM6 ssp585 low
#./check_run_func.sh MARv3.9 UKESM1-CM6 ssp585 med
#
...
#./check_run_func.sh MARv3.12 CESM2 ssp585 high
#./check_run_func.sh MARv3.12 CESM2 ssp585 low
#./check_run_func.sh MARv3.12 CESM2 ssp585 med
...
#./check_run_func.sh MARv3.12 UKESM1-CM6 ssp585 high
#./check_run_func.sh MARv3.12 UKESM1-CM6 ssp585 low
#./check_run_func.sh MARv3.12 UKESM1-CM6 ssp585 med

# wide Ks
./check_run_func.sh MARv3.9 ACCESS1.3 rcp85 p05
./check_run_func.sh MARv3.9 ACCESS1.3 rcp85 p95
#./check_run_func.sh MARv3.9 CESM2 ssp585 p05
#./check_run_func.sh MARv3.9 CESM2 ssp585 p95
...
#./check_run_func.sh MARv3.9 UKESM1-CM6 ssp585 p05
#./check_run_func.sh MARv3.9 UKESM1-CM6 ssp585 p95
#
#./check_run_func.sh MARv3.12 ACCESS1.3 rcp85 p05
#./check_run_func.sh MARv3.12 ACCESS1.3 rcp85 p95
#./check_run_func.sh MARv3.12 CESM2 ssp585 p05
#./check_run_func.sh MARv3.12 CESM2 ssp585 p95
...
#./check_run_func.sh MARv3.12 UKESM1-CM6 ssp585 p05
#./check_run_func.sh MARv3.12 UKESM1-CM6 ssp585 p95
#
